...
§\ref{subsec:penalizacion-transferencia}. El costo de transbordo suma el
tiempo de caminata entre estaciones más la espera promedio hasta el siguiente
servicio. La implementación de producción está integrada en
\texttt{graph\_builder.py}; el prototipo aquí presentado es de referencia.
