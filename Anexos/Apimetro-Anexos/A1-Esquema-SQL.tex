...
\lstinputlisting[language=SQL, caption={DDL completo de \texttt{Apimetro}: tablas, restricciones e índices espaciales GiST.}, label=lst:sql-init-completo, breaklines=true, basicstyle=\small\ttfamily] {Anexos/Apimetro-Anexos/SQL/ejemplo_init.txt}
...
\lstinputlisting[language=SQL, caption={Fragmento de \texttt{seed.sql}: líneas del Mexibús y Mexicable con métricas integradas.}, label=lst:sql-seed, breaklines=true, firstline=29, lastline=37, basicstyle=\small\ttfamily] {Anexos/Apimetro-Anexos/SQL/ejemplo_seed.txt}
