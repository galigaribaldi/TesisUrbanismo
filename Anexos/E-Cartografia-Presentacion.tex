...
el sistema \textbf{Transport-gis-zmvm-mjg},
generadas con QGIS~3.x a partir de las plantillas institucionales de la
\textsc{unam}. Los mapas utilizan la proyección
\textsc{epsg}:32614 (UTM zona~14N) y tienen como fuente base los \textit{feeds}
\gtfs{} de la \textsc{semovi} (2024) y la cartografía
del \textsc{inegi} (2023). Versiones reducidas de estos mapas se encuentran en
los capítulos~\ref{ch:Capas-codigo}
