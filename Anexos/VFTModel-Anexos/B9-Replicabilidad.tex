...
Los endpoints de indicadores exigen que el grafo esté construido y en caché.
...
La suite cuenta con 39 pruebas de integración que verifican la cadena
completa: validación Pydantic, construcción del grafo y cálculo de cada
indicador. Requiere el servidor activo y acceso a Apimetro:
