...
El despliegue de VFTModel se basa en tres archivos de configuración que
permiten levantar el servicio tanto en entorno local como en producción sin
modificar el código fuente.

\subsection*{Dependencias Python}

El archivo \texttt{requirements.txt} agrupa las dependencias en tres
...
La imagen Docker utiliza una construcción multietapa (\termino{multi-stage
build}) para minimizar el tamaño de la imagen de producción: el
\textit{stage} \texttt{builder} compila e instala las dependencias con todas
las herramientas de desarrollo, y el \textit{stage} \texttt{runtime} solo
copia los paquetes ya instalados y el código fuente.
...
incluye el paquete \texttt{libgdal32} en sus repositorios estables al momento
de escritura del presente trabajo.
