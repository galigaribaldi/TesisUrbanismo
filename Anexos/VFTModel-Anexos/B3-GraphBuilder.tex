...
\texttt{nx.DiGraph}) a partir del \textsc{geojson} ya validado por Pydantic. La
construcción ocurre en tres fases secuenciales y una opcional:
...
distancias entre estaciones del \textsc{geojson} de Apimetro (corrida
2026-04-18). El umbral por defecto para análisis es $Q_1 = 85$\,m, que
representa el transbordo directo más conservador.
