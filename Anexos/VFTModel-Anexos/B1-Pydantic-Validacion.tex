...
haber pasado por la taxonomía del modelo. El Cuadro~\ref{tab:vft-campos-validados}
presenta los campos validados; el código siguiente muestra las enumeraciones y
el validador dinámico que imputa los valores faltantes.
...
grafo. Las imputaciones cubren cuatro casos frecuentes en el \textsc{geojson}
de Apimetro.
