...
indicador: construye el grafo, aplica la impedancia y almacena el resultado
en un caché en memoria (\texttt{Singleton}). Los parámetros configurables son
el modo de construcción y la tolerancia de transbordo:
