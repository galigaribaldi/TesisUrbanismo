...
La función \texttt{haversine} calcula la distancia geodésica en metros entre dos
coordenadas geográficas proyectando la curva terrestre sobre la esfera de radio
$R = 6\,371\,000$\,m. Es la distancia base para el tiempo de traslado en todas
las aristas de tránsito y para el tiempo de caminata en las aristas de
transbordo.
...
\texttt{tipo = transfer}) ya tienen peso propio asignado por el constructor del
grafo y se omiten.
