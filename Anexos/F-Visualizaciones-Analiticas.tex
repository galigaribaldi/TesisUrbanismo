...
% --- F.3.9 -------------------------------------------------------------------
\subsection{Gráfica: Tiempo de Viaje Promedio (\texorpdfstring{$T$}{T}) por Alcaldía}
\label{anx:f-tab-vft-t-promedio}
...
\begin{figure}[htb]
  ...
  \caption[Tiempo de viaje promedio $T$ por alcaldía --- \zmvm{}]{%
  Tiempo de viaje promedio ($T$) por alcaldía de la \zmvm{}, calculado
  sobre el componente gigante del grafo (10,561~nodos) con el algoritmo
  de \dijkstra{} ponderado por $CF$ y $T_b$. Corrida: 2026-09-02.}
  \label{fig:anx-f-tab-vft-t-promedio}
