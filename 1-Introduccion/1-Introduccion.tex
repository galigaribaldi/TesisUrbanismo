...
ampliación de vialidades urbanas solo ofrece una solución temporal: al cabo de tres
...
el motor de datos \textit{Apimetro} \textcite{cabrera2025apimetro}. Con el fin de determinar el impacto teórico de
la implementación de un corredor circular de transporte público masivo en el Anillo Periférico de 
...
con una vialidad de trazo circular —el Anillo Periférico—, esta se ha orientado históricamente al automóvil 
