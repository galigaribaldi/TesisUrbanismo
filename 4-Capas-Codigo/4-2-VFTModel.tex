...
\\
\termino{Vanishing Fig-Tree Model} se basa en dos referencias clave en diferentes ámbitos, 
mientras uno es literario y describe la desesperanza de una situación crítica ante una decisión 
tan trascendente. El otro describe de manera lírica el llamado \termino{Punto de No Retorno}: 
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{Figures/Cap4/EsquemaVFTArquitecture.png}
  \caption[Aquitectura esquemática VFTModel]{Esquema creado para el VFTModel}
  \label{fig:VFTModel-icon}
  \fuentefigura{Elaboración propia con Gemini.}
\end{figure}
