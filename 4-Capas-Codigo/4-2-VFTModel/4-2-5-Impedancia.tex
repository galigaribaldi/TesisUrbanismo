...
aplicando vía mixta ($CF = 1.759$) como caso conservador por defecto. La implementación Python completa se presenta en el
...
recibieron su peso durante la construcción del grafo: su costo suma el tiempo
de caminata entre estaciones más la espera promedio hasta el siguiente servicio
(véase la Sección~\ref{subsec:res-penalizacion-transferencia} del
Capítulo~\ref{ch:resultados-vft}). El peso de cada arista —en minutos— es la
entrada de todos los algoritmos de caminos mínimos ejecutados en los indicadores
de Fase~3.
