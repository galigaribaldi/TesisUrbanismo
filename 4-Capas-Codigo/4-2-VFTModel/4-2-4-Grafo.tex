...
El módulo central de VFTModel es la clase \texttt{VFTGraphBuilder}, responsable
de transformar las geometrías \geojson{} en un \textbf{dígrafo} representado
...
metropolitana, cuyas definiciones se presentan en el Cuadro~
\ref{tab:vft-umbrales}.
...
\begin{description}
    ...
    presentados en el Capítulo~\ref{ch:analisis-red-actual}.
\end{description}

Con el grafo topológico construido y los modos de operación definidos, el paso
siguiente es asignar a cada arista un peso temporal mediante el motor de
impedancia.
