...
directorio \texttt{data/processed/}. Los fragmentos de código de estos componentes se documentan en el Anexo~\ref{anx:transportgis-tecnico}.\pendiente{Crear Anexo — Documentación Técnica Transport-gis}
