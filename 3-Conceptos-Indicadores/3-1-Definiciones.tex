...
\textcite{fortin2016} argumentan que, hasta la fecha de su investigación, no existía
...
\textcite{fortin2016} proponen explícitamente la \termino{comparación de redes}
...
\begin{figure}[H]
   ...
   \fuentefigura{\textcite{fortin2016}, p.~21.}
 \end{figure}
...
\textcite{fortin2016} plantean que los indicadores derivados de la teoría de grafos
...
\textcite{fortin2016} señalan que los indicadores de accesibilidad más comunes se
...
\begin{figure}[H]
   ...
   \fuentefigura{\textcite{fortin2016}, p.~23.}
 \end{figure}
