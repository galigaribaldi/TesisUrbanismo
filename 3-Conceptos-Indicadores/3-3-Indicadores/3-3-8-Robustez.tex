...
\citet{lotero2014vulnerabilidad} definen la vulnerabilidad operativamente como la
...
Conforme a la nota aclaratoria de §\ref{sec:indicadores-formulas}, la
validación empírica de $\Delta E$ queda propuesta como línea de investigación
futura.
