...
(§\ref{subsec:obj-especificos}): los indicadores de la Fase 1 ---$C$, $C_i$,
$DI$ y $CF_h$--- alimentan los Objetivos Específicos 2 y 4; el de la Fase 2
---$W_{s,h}$--- refina el grafo del Objetivo Específico 1; el Tiempo de Viaje
