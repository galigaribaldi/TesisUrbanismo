...
nodos estructurales de alta capacidad que articulan los flujos intermodales de
la
metrópoli. El análisis de su cobertura espacial mediante isócronos peatonales de
800~m permite identificar las demarcaciones que se benefician directamente de
este
...
Metro, evidenciando la concentración de la infraestructura ferroviaria en el
núcleo
...
red del Metro. No obstante, al evaluar su cobertura mediante isócronos
peatonales
de 800~m, persisten notables brechas territoriales, dejando a varias
demarcaciones
...
concentración
del servicio en las zonas centro, norte y oriente de la ciudad, siguiendo los
ejes
viales primarios.
...
específicos (como en Gustavo A. Madero, Iztapalapa y Álvaro Obregón),
contrastando
...
implementación de infraestructura pesada es inviable. Su extensión territorial
es
...
concentración
del servicio en el centro y norte de la ciudad, donde la densidad de rutas y
paradas
...
espacial
del Trolebús. El mapa visibiliza la fuerte concentración del servicio en
alcaldías
como Benito Juárez, Cuauhtémoc, Iztacalco e Iztapalapa (impulsada por el
Trolebús
Elevado), contrastando drásticamente con la carencia de infraestructura
eléctrica
...
secundarios de la ciudad consolidada, este sistema presenta uno de los niveles
de
cobertura territorial más altos de la metrópoli, especialmente en las alcaldías
de
mayor densidad urbana del centro y el oriente. Más que un sistema residual, los
Corredores Concesionados actúan como la red capilar que penetra en los
intersticios
...
la
alcaldía Cuauhtémoc y el extremo norte de Azcapotzalco, mientras que el resto
del
...
(Cuadro~\ref{tab:cobertura-interurbano-cdmx}). Para la visualización
cartográfica
...
Universidad
Nacional Autónoma de México (UNAM), de carácter público y gratuito, cuya
operación
se circunscribe al campus de Ciudad Universitaria. Si bien el modelo registra
una
...
dentro del polígono universitario y no un alcance funcional sobre la trama
urbana
circundante. El resto de las demarcaciones capitalinas registra coberturas
menores
...
sintetizan esta lectura mediante dos representaciones cartográficas
complementarias
...
de
máxima accesibilidad y los vacíos periféricos. Las versiones a página completa
se
