...
documentados por los organismos operadores de la \zmvm. La velocidad efectiva se
obtiene a partir de la Ecuación~\eqref{eq:velocidad-efectiva}:
...
\colorbox{azulRevision}{El Cuadro~\ref{tab:validacion-impedancia} sintetiza los resultados}
de la corrida del modelo del 16 de abril de 2026, ejecutada sobre
...
es el del \textbf{Trolebús}, cuya velocidad efectiva ($\approx
$\, 13.0~km/h con $C_f = 1.38$) se sitúa ligeramente por debajo del límite
inferior del rango operativo documentado (14--22~km/h). Esta diferencia de
aproximadamente 1~km/h (7\%) es atribuible a que el tipo de derecho de vía
\textit{compartido} no captura la preferencia operativa parcial que el trolebús
mantiene en ciertas vialidades de la \textsc{cdmx}. Para fines de análisis
estructural de red, esta desviación se encuentra dentro de los márgenes de
