...
% --- Figura: pipeline de procesamiento VFT ---
\begin{figure}[H]
    \centering
    \input{Figures/TiKz_Libraries/Diagramas/vft-pipeline-procesamiento}
    \caption[Pipeline de procesamiento del Modelo VFT]{Las cuatro etapas de
    transformación que convierten los datos brutos de \texttt{Apimetro} en el
    grafo topológico operativo. El \termino{Snapping Lógico Geográfico} mediante
    árbol \texttt{KDTree} reduce las 22{,}766 entidades originales a
    11{,}115 nodos canónicos; la ponderación final asigna impedancias temporales
    a cada una de las 45{,}679 aristas del grafo dirigido
...
La ingesta de datos desde \texttt{Apimetro} proporcionó
\textbf{22{,}766 entidades espaciales} que, tras el proceso de
\termino{Snapping Lógico Geográfico} mediante un árbol \texttt{KDTree} con
tolerancia de 50~m, se consolidaron en un grafo dirigido con las siguientes
dimensiones:
