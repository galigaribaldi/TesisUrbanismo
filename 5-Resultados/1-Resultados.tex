...
requiere los pesos dinámicos derivados de la Fase~1; y la Fase~3 exige que las
dos anteriores estén completas para ejecutar los algoritmos de caminos mínimos y
...
% =============================================================================
\input{5-Resultados/5-1-Introduccion-Resultados}
\input{5-Resultados/5-2-1-Resultados-VFT-Fase1}
\input{5-Resultados/5-2-2-Resultados-VFT-Fase2}
\input{5-Resultados/5-2-3-Resultados-VFT-Fase3}
