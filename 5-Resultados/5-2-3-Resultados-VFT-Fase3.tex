...
y
nodos, los tres indicadores de esta fase requieren la ejecución de
\textbf{algoritmos
de caminos mínimos} sobre la totalidad del grafo ponderado, lo que implica
tiempos
de cómputo del orden de horas para un grafo de 11{,}115 nodos y 45{,}679
aristas.
...
solo valor, el efecto combinado de la geometría de la red, los tiempos de
traslado
...
estructurales
o cuellos de botella en los transbordos. La comparación de $T$ antes y después
de
...
estaciones de origen-destino frecuente, sino \termino{hubs} de paso que
articulan
